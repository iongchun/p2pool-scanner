...
function Scanner(options) {
    ...
    self.render = function() {
        ...
        _.each(list, function(info) {
            ...
            str += "<div class='p2p-row "+(row++ & 1 ? "row-grey" : "")+"'><div class='p2p-ip'><a href='http://"+ip+":"+port+"/static/' target='_blank'>"+ip+":"+port+"</a></div><div class='p2p-version'>"+version+"</div><div class='p2p-fee'>"+fee+"%</div><div class='p2p-uptime'>"+uptime+" days</div>";
